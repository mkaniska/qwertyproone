...
<script language="javascript">
	...
	function dologin() {
		$("#login_result").html('');
		if($.trim($("#user_name").val())!='' || $.trim($("#login_password_text").val())!='') {
			 $.ajax({
				  type: 'POST',
				  url: '<?php echo base_url();?>user/processlogin',
				  beforeSend: function(){  },
				  data: 'username='+$("#user_name").val()+'&password='+$("#login_password_text").val(),
				  dataType: "text",
				  success: function(resultData) {
				...
				<form id="loginForm" method="post">
					<fieldset id="body">					
						...
						<div style="float:left;margin-left:10px;margin-top:5px;">
							...
							<input type="password" name="password_text" id="login_password_text" size="20" /> &nbsp;
