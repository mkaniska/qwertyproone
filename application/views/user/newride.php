...
<div style="border:1px solid gray; width:900px; margin-bottom: 1em; padding: 10px">
	...
	<div id="step1" class="tabcontent">
		...
		<table width="100%" cellpadding="4" cellspacing="3">
			...
			<tr><td width="50%">   </td><td width="50%"></td></tr>			
			<tr>
				<td width="50%"><label>Start Time:&nbsp;</label><input type="text" id="origin_from" name="searchTextField" class="required input_field" style="width:150px;" /></td>
				<td width="50%"><label>Return Time:&nbsp;</label><input type="text" id="destination_to" name="searchTextField2" class="required input_field" style="width:150px;" /></td>
			</tr>			
			<tr><td width="50%">   </td><td width="50%"></td></tr>
			<tr>
