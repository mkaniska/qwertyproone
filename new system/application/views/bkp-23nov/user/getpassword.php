					...
					<table width="100%" cellpadding="4" cellspacing="3" align="center">
						...
						<tr>
							<td width="100%" colspan="2" align="left" style="padding-left:152px;">
								<input class="submit_btn float_l" type="button" name="submitretrivepwd" id="submitretrivepwd" value="Send" onclick="javascript:validateInfo();" /> &nbsp; &nbsp;  &nbsp;	
								<input class="submit_btn float_l" type="button" name="cancelBtn" id="cancelBtn" value="Cancel" onclick="javascript:window.location.href='<?php echo base_url();?>user/login'" /><br />
							</td>
						</tr>				
					</table>				
				</form>
