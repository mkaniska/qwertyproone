<table width="100%" cellpadding="3" cellspacing="0" align="center" border="1">
	...
	<tr style="font-size:11px;text-align:left;padding-left:3px;"> 				
		<td><?php echo $out->pro_user_full_name;?> <br /> (For <?php echo $out->posting_for;?>)</td>
	...
	<tr style="font-size:11px;">
		<td colspan="6" align="center" id="additionalInfo"><?php //echo $pagelink;?></td>
	</tr>				
	<?php }else { ?>
	<tr>
		<td colspan="6" style="color:#ff0000;text-align:center;font-weight:bold;">No Results Found</td>
	</tr>
	<?php } ?>
</table>