...
function initialize() {
  ...
  google.maps.event.addListener(marker, 'dragend', function() {
    geocodePosition(map,infowindow,marker,marker.getPosition(),'#searchTextField');
  });
  ...
  google.maps.event.addListener(marker2, 'dragend', function() {
    geocodePosition(map2,infowindow2,marker2,marker2.getPosition(),'#searchTextField2');
  });
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function() {
    ...
    marker.setIcon(/** @type {google.maps.Icon} */({
      url: 'http://localhost/qwerty/images/marker.png',
