        ...
        <div class="post">
			...
			<form action="<?php echo base_url();?>ride/update_ride" method="post" style="margin:20px;" onsubmit="return isValidRide();" style="color:#555555;">
				<table width="100%" cellpadding="4" cellspacing="3" align="center">
					...
					<tr>
						...
						I am a : <br />
							<select name="travel_type" id="travel_type" onchange="javascript:enableFields(this.value);">
								...
								<option value="reference" <?php if($ride_value->travel_as=='reference'){?> selected="selected" <?php } ?>>On Behalf of Owner (Referrer)</option>
					...
					<tr><td width="100%" colspan="2">  </td></tr>
					<tr>
						<td width="50%"> Origin Location :&nbsp;  <br />
						...
						<td width="50%"> Destination Location :&nbsp; <br />
					...
					<tr>
						<td width="100%" colspan="2" align="left">
							...
							<input type="radio" id="preferred_gender1" name="preferred_gender" value="Male" <?php if($ride_value->preferred_gender=='Male'){?> checked="checked" <?php } ?> /> Male &nbsp;
							<input type="radio" id="preferred_gender2" name="preferred_gender" value="Female" <?php if($ride_value->preferred_gender=='Female'){?> checked="checked" <?php } ?> /> Female 
						</td>
					</tr>					
					<tr>
						<td width="100%" colspan="2" align="left">
