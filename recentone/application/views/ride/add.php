				...
				<div id="tabs-1">
					<table width="100%" cellpadding="4" cellspacing="3" align="center">
						...
						<tr>
							<td width="50%">							
							State :
								<select name="location_state" id="location_state" onchange="javascript:get_cities(this.value,'','location_city','#city_location');">
					...
					<table width="80%" cellpadding="4" cellspacing="3" align="center">
						...
						<tr>
							<td width="100%" colspan="2" align="left"> I am a : 
								<input type="radio" id="travel_type2" name="travel_type" value="driver" checked="checked" /> Own Vehicle (Driver/Owner) &nbsp; 
								<input type="radio" id="travel_type3" name="travel_type" value="reference" /> On Behalf of Owner (Referrer) &nbsp;
						...
						<tr>
							<td width="100%" colspan="2" align="left">
							Preferred Co-Passenger's Gender : 
								<input type="radio" id="preferred_gender3" name="preferred_gender" value="All" checked="checked" /> Any &nbsp;
								<input type="radio" id="preferred_gender1" name="preferred_gender" value="Male" /> Male &nbsp;
								<input type="radio" id="preferred_gender2" name="preferred_gender" value="Female" /> Female 
							</td>
						</tr>
						<tr>
							<td width="100%" colspan="2" align="center">
				...
				<div id="tabs-3">
					...
					<table width="80%" cellpadding="4" cellspacing="3" align="center">
						...
						<tr>
							...
							<td width="80%"><input type="text" maxlength="30" id="email_address" name="email_address" value="" class="required input_field" onblur="javascript:isEmailAvailable(this.value,'#errorDisplay2');" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="80%">						
								...
								<?php foreach($states_list as $key=>$value) { ?>
									<option value="<?php echo trim($value->city_state);?>"><?php echo trim($value->city_state);?></option>
								<?php } ?>
								</select>
							</td>
						</tr>
