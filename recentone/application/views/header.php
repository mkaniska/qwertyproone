...
<div id="website_header_wrapper">
	<div id="website_header" class="wrapper">
    	<div id="site_title"><a href="<?php echo base_url();?>welcome/home">CodeIgniter Sample Application</a>
		<font style="font-size:10px;color:#fff;">Providing convenience and offers to the employees across India</font>
		</div>
