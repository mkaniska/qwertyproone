<?php 
  ...
  else if(in_array($page_name,$menus[4])){$tabActive=4;}
  else{$tabActive=4;}
?>
...
<head>
    ...
    <?php if($page_name=='admin/login' || $page_name=='admin/ride_list' || $page_name=='admin/company_list' || $page_name=='admin/offer_list' || $page_name=='admin/user_list' || $page_name=='admin/type_list' || $page_name=='admin/ads_list' || $page_name=='admin/discount_list') { ?>
