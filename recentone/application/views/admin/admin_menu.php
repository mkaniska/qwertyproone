<div class="grid_12">
	<ul class="nav main">
		<li class="ic-dashboard"><a href="<?php echo base_url();?>admin/company_list"><span>Manage Company</span></a> </li>
		<!--<li class="ic-form-style"><a href="javascript:"><span>Manage</span></a>
			<ul>
		...
		<li class="ic-discount"><a href="<?php echo base_url();?>admin/discount_list"><span>Manage Discounts</span></a></li>
	</ul>
</div>
<div class="clear"></div>