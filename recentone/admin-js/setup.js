...
function validCompany() {
	...
	else if(!validatePhone($.trim($("#phone").val()))){$("#errorDisplay").html("Please enter a valid phone number");$("#phone").focus();ok = false;}
	if(ok==true){	
		return true;
	}else { return false; }
}
...
function validDiscount() {
	$("#errorDisplay").html('');
	var ok = true;
	if($.trim($("#discount_title").val())==''){$("#errorDisplay").html("Please enter the Discount Title");$("#discount_title").focus();ok = false;}
	else if($("#discount_type").val()==0){$("#errorDisplay").html("Please select the Discount type");$("#discount_type").focus();ok = false;}
	else if($.trim($("#discount_provider").val())==''){$("#errorDisplay").html("Please enter the Discount provider");$("#discount_provider").focus();ok = false;}
	else if($.trim($("#discount_city").val())=='0'){$("#errorDisplay").html("Please select the Discount City");$("#discount_city").focus();ok = false;}
	else if($.trim($("#contact_person").val())==''){$("#errorDisplay").html("Please enter the contact person");$("#contact_person").focus();ok = false;}
	else if($.trim($("#contact_phone").val())==''){$("#errorDisplay").html("Please enter the contact phone");$("#contact_phone").focus();ok = false;}
	else if(!validatePhone($.trim($("#contact_phone").val()))){$("#errorDisplay").html("Please enter a valid phone number");$("#contact_phone").focus();ok = false;}
	else if($.trim($("#discount_notes").val())==''){$("#errorDisplay").html("Please enter the notes");$("#discount_notes").focus();ok = false;}
...
function validSetting() {
	...
	else if(!validatePhone($.trim($("#office_phone").val()))){$("#errorDisplay").html("Please enter a valid phone number");$("#office_phone").focus();ok = false;}
	if(ok==true){	
		return true;
	}else { return false; }
}
...
function validAds() {
	$("#errorDisplay").html('');
	var ok = true;
	if($.trim($("#ads_title").val())==''){$("#errorDisplay").html("Please enter the Ads Title");$("#ads_title").focus();ok = false;}
	else if($.trim($("#ads_url").val())==''){$("#errorDisplay").html("Please enter the Ads URL");$("#ads_url").focus();ok = false;}
	else if($.trim($("#ads_comments").val())==''){$("#errorDisplay").html("Please enter the Comments");$("#ads_comments").focus();ok = false;}
	if(ok==true){
		return true;
	}else { return false; }
}
...
function get_cities(state_name,select_city,field_name,response_id){
	if($.trim(state_name)!=''){
		 $.ajax({
			  type: 'POST',
			  url: 'http://localhost/qwerty/ride/get_cities',
			  beforeSend: function(){  },
