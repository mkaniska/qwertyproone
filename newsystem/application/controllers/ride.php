	...
	public function process_ride() {
		...
		if($this->input->post('submitride')=='Submit') {
			...
			// Send an activation email & notifications
				...
				$rideMessage = "Hello ".$user_data['pro_user_type'].", <br />";
				...
				if($ride_data['travel_as']=='driver'){
					$rideMessage.= "Vehicle Type : ".$user_data['pro_user_type'].", <br />";	
					$rideMessage.= "Model Type : ".$user_data['pro_user_type'].", <br />";	
					$rideMessage.= "Fuel Type : ".$user_data['pro_user_type'].", <br />";
				}
				$rideMessage.= " <br />";
