    <div id="sliderFrame">
        ...
        <div id="thumbs">
            <div class="thumb">
                <div class="thumb-content"><div class="frame"><img src="<?php echo base_url();?>images/thumb1.jpg" /></div>
					<p>Travel Easy</p>
					Pay less to your daily travel expense by Posting your travel route. People join your way & share your cost!.
					&nbsp;<a href="<?php echo base_url();?>welcome/services">more...</a>
				</div>
                <div style="clear:both;"></div>
            </div>
            <div class="thumb">
                <div class="thumb-content"><img src="<?php echo base_url();?>images/thumb2.jpg" />
				<p>Recent Offers</p>
				We let you know the recent offers on your city. Just pay attension and get benifitted thru us!.
				&nbsp;<a href="<?php echo base_url();?>welcome/services">more...</a>
				</div>
                <div style="clear:both;"></div>
            </div>
            <div class="thumb">
                <div class="thumb-content"><img src="<?php echo base_url();?>images/thumb3.jpg" />
				<p>Corporate Discounts</p>
				Avail more exciting corporate offers here. Your company also be a part of us to avail this!.
				&nbsp;<a href="<?php echo base_url();?>welcome/services">more...</a>
				</div>
                <div style="clear:both;"></div>
            </div>
            <div class="thumb">
                <div class="thumb-content"><img src="<?php echo base_url();?>images/thumb4.jpg" />
				<p>Online Reservation</p>
				Make your cab booking easy Online. Travels will reach you at your door step!.
				&nbsp;<a href="<?php echo base_url();?>welcome/services">more...</a>
				</div>
                <div style="clear:both;"></div>
            </div>
