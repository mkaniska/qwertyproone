						...
						<td>
							<table width="100%" cellpadding="5" cellspacing="5" align="center" id="mytable">
								...
								<tr>
									...
									<td width="35%"> 
									<input type="text" name="valid_from" id="valid_from" class="input_fields_small" />
									</td> 
									<td width="15%" class="form_label"> Valid To</td> 
									<td width="35%"> 
									<input type="text" name="valid_to" id="valid_to" class="input_fields_small" /></td>
								</tr>
								<tr>
									...
									<td width="35%"> 
									<textarea name="notes" id="notes" cols="25" rows="4"></textarea>
									</td> 
								</tr>
								<tr>
									<td colspan="4"> </td>
