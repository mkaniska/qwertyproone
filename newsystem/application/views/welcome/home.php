<div id="website_main" class="wrapper">
	...
	<div id="website_bottom" class="wrapper">
    	...
    	<div class="col one_fourth_footer1">
            <h4 style="padding-bottom:10px;text-align:left;padding-left:50px;">Who we are ?</h4>
            <p> 
    	...
    	<h4 style="padding-bottom:10px;text-align:left;padding-left:50px;">Recent Joinees !</h4>
    	...
    	<h4 style="padding-bottom:10px;text-align:left;padding-left:50px;">Recently Posted Rides</h4>
			<!--
