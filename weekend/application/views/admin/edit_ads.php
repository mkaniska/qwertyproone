...
<div class="grid_10">
	<div class="box round first grid">
		<h2>Edit Ads Details</h2>
		<div style="margin:25px;">
			<form action="<?php echo base_url();?>admin/process_updateads" method="post" name="updateAds" onsubmit="return validAds();" enctype="multipart/form-data">
						...
						<td>
							<table width="80%" cellpadding="5" cellspacing="5" align="left" id="mytable">
								...
								<tr>
									...
									<td width="70%"> 
										<input value="<?php echo $ads_title;?>" type="text" name="ads_title" id="ads_title" class="input_fields" />
									</td>
								</tr>
								<tr>
									...
									<td width="70%"> 
										...
										<input value="0" type="radio" name="ads_status" id="ads_status" <?php if($ads_status=='0'){?> checked="checked" <?php } ?>  /> In-Active 
									</td> 
								</tr>
								<tr>
									<td width="20%" class="form_label">Site URL</td> 
									<td width="70%"> 
										<input value="<?php echo $ads_url;?>" type="text" name="ads_url" id="ads_url" class="input_fields" />
									</td>
								</tr>
								<tr>
									...
									<input type="hidden" name="id" id="id" value="<?php echo $ads_id;?>" />
									</td> 
								</tr>
								<tr>
									<td width="20%" class="form_label" valign="top"> Comments</td> 
									<td width="70%"> 
									<textarea name="ads_comments" id="ads_comments" cols="40" rows="6"><?php echo $ads_comments;?></textarea>
									</td>
								</tr>
								<tr>
									<td colspan="2"> </td>
								...
								<tr>
									<td colspan="2" align="center">
										<input type="submit" class="buttons" id="submitbutton" name="updateAds" value="Update" /> &nbsp;  &nbsp;
